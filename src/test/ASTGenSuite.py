...
class ASTGenSuite(unittest.TestCase):
	...
	def test_25(self):
		...
		expect = str(Program([ClassDecl(Id("add"),[
			MethodDecl(Instance(),Id("main"),[],IntType(),
			Block([VarDecl(Id("b"),IntType()),
				VarDecl(Id("a"),IntType(),IntLiteral(4)),
	...
	def test_26(self):
		...
		expect = str(Program([ClassDecl(Id("add"),[
			MethodDecl(Instance(),Id("main"),[],IntType(),Block([
				VarDecl(Id("b"),ArrayType(3,IntType())),
				VarDecl(Id("c"),ArrayType(3,IntType())),
				VarDecl(Id("a"),ArrayType(3,IntType()),ArrayLiteral([IntLiteral(1),IntLiteral(2),IntLiteral(3)]))],[]))])]))
	...
	def test_27(self):
		...
		expect = str(Program([ClassDecl(Id("add"),[MethodDecl(Static(),Id("main"),[],IntType(),Block([VarDecl(Id("b"),ArrayType(3,IntType())),VarDecl(Id("c"),ArrayType(3,IntType())),VarDecl(Id("a"),ArrayType(3,IntType()),ArrayLiteral([IntLiteral(1),IntLiteral(2),IntLiteral(3)]))],[Return(ArrayCell(Id("a"),IntLiteral(2)))]))])]))
	...
	def test_30(self):
		...
		expect = str(Program([ClassDecl(Id("add"),[MethodDecl(Instance(),Id("main"),[],IntType(),Block([],[Assign(FieldAccess(Id("this"),Id("a")),IntLiteral(3))]))])]))
